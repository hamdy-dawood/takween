...
import '../controller/supermarket_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<SupermarketCubit, SupermarketState>(
          builder: (context, state) {
            final controller = SupermarketCubit.get(context);
            return Column(
              children: [
                Expanded(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    ...
                    child: Image.asset(
                      "assets/images/supermarket/${index + 1}.jpg",
                      height: 500,
                      width: 400,
                    ),
                  ),
