...
import '../controller/adha_cubit.dart';

class AdhaScreen extends StatelessWidget {
  const AdhaScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => AdhaCubit(),
        child: Scaffold(
            backgroundColor: Color(0xffeefcff),
            appBar: AppBar(
            ...
            body: BlocBuilder<AdhaCubit, AdhaState>(
              builder: (context, state) {
                final controller = AdhaCubit.get(context);
                  ...
                  children: [
                    Expanded(
                      ...
                      itemBuilder: (context, index) => GestureDetector(
                        ...
                        child:
                            Image.asset("assets/images/adha/${index + 1}.jpg"),
                      ),
                    )),
                    Row(
                      children: [
